          ...
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                ...
                <span class="delivery">{{rating.deleveryTime}}</span>
              </div>
...
<script>
  ...
  export default {
    data(){
      return {
        selectType:0,//评价类别：2：全部，0：满意，1：不满意
    ...
    mounted(){
      ...
      //订阅消息
      PubSub.subscribe('setSelectType',(msg,selectType)=>{
        this.setSelectType(selectType);
      });
      PubSub.subscribe('toggleOnlyContent',(msg)=>{
    ...
    computed:{
      ...
      filterRatings(){
        ...
        return ratings.filter(rating=>{
          ...
          *   selectType:0/1/2
          *   rateType:0/1
          *   满足条件：selectType===2 || selectType===rateType
          * */
          /*
          * 条件2：评价内容
          *   onlyContent：true/false
          *   text:有值/没值
          *   满足条件：!onlyContent || text.length>0
          * */
    ...
    methods:{
      ...
      toggleOnlyContent(){ //是否只显示有内容的评价，点击取反
